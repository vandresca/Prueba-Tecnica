...
namespace intCodeProgram
{
    public class ProcessIntCode
    {
        ...
        public Dictionary<String, Object> run(Dictionary<String, Object> arguments)
        {
            Dictionary<String, Object> response = new Dictionary<String, Object>();
            try
            {
                //Convierte el array de String de valores del fichero a un array de enteros
                int[] intCode = Utils.StringToIntegerArray((string[])arguments["contentFile"]);
                ...
                //Paramos el cronometro para medir lo que dura la tarea
                ((System.Diagnostics.Stopwatch)arguments["clock"]).Stop();

                //Capturamos el valor de la duración de la tarea
                TimeSpan timespan = ((System.Diagnostics.Stopwatch)arguments["clock"]).Elapsed;
                
                //Añadimos los datos a un diccionario
                response.Add("time", timespan.TotalMilliseconds + "\n");
                response.Add("result", Utils.IntegerToStringArray(intCode));
